...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CXd51wwACBb9kRqejbd78xOLqyU2uOfI-z9W6SQACOAgAAiOMOFaFynqrwW54Qi8E")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ʙᴏᴛs](https://t.me/TheYurri) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
                        msg += f"🔗 [{sᴜᴘᴘᴏʀᴛ }](https://t.me/AeroBots_Tm}) ** played {count} times**\n\n"
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• ʙᴏᴛs •", url="https://t.me/TheYurri"
                        ),
                    ],
                ]
            )
